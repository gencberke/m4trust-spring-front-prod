...
function CreateDealForm({ error, isPending, onSubmit }: CreateDealFormProps) {
  ...
  return (
    ...
    >
      <div className="panel-heading">
        ...
        <p>Aktif kuruluş ilk katılımcı olur. Yalnızca başlık zorunludur.</p>
      </div>
...
export function DealListWorkspace({
  ...
  return (
    <main className={`workspace-main ${styles.workspace}`}>
      <div className="workspace-column">
        ...
        <p className="workspace-lead">
          Anlaşmaları görüntüleyin, filtreleyin ve uygun olduğunda yeni bir
          taslak oluşturun.
        </p>
        ...
        <div className={styles.layout}>
          <section className={`workspace-panel ${styles.listPanel}`}>
            <div className={`panel-heading ${styles.listHeading}`}>
              <div>
                <span className="section-kicker">
                  Katılımcı olduğunuz kayıtlar
                </span>
                <h2>Anlaşmalar</h2>
              </div>
            ...
            <div
              ...
              aria-label="Anlaşma liste kontrolleri"
            >
              <label>
                <span>Durum</span>
                <select
                ...
                {deals.map((deal) => (
                  ...
                  >
                    <div>
                      ...
                      <h3>{deal.title}</h3>
                      <p>
                        Güncellendi {formatDate(deal.updatedAt, "medium-short")}
                      </p>
                    </div>
            ...
            {dealsQuery.data && dealsQuery.data.totalPages > 0 ? (
              <div className={styles.pagination}>
                ...
                <span>
                  ...
                  {dealsQuery.data.totalPages} · {dealsQuery.data.totalElements}{" "}
                  kayıt
                </span>
                <button
                  className="text-button"
