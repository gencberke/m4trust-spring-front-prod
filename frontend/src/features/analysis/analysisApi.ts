...
export type DealDocumentAnalysis =
  components["schemas"]["DealDocumentAnalysis"];
export type DocumentAnalysisStatus =
  components["schemas"]["DocumentAnalysisStatus"];
export type DocumentAnalysisResult =
  components["schemas"]["DocumentAnalysisResult"];
export type ExtractedRuleValue = components["schemas"]["ExtractedRuleValue"];
export type ExtractionSourceReference =
  components["schemas"]["ExtractionSourceReference"];
...
export function getDealDocumentAnalysis(
  ...
  return requestJson<DealDocumentAnalysis>(
