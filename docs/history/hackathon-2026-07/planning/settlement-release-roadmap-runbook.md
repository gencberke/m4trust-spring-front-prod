> **Not project state.** This runbook is a historical planning/execution guide; accepted Plan 17/18 in `docs/history/hackathon-2026-07/done/` supersede its actionable roadmap framing. Authoritative accepted state is `docs/plan/CURRENT.md` and `docs/plan/ready|done/`. Do not treat this document as implementation authority.
...
- Opened: 21 July 2026
- Gate authority: `docs/history/hackathon-2026-07/planning/gates/settlement-release-readiness-charter-2026-07-21.md`
...
| --- | --- | --- |
| Slice 7 | `docs/history/hackathon-2026-07/done/07-staging-deployment.md` | ACCEPTED; preserve evidence |
...
task; preserve `docs/history/hackathon-2026-07/done/review/14a-15p4-implementation-review-handoff.md`.
...
1. Validate `docs/history/hackathon-2026-07/review/req-review.md` shape and exact HEAD.
