> **Not project state.** Founder decision input for ADR-014/14B planning; accepted Plan 17 in `docs/history/hackathon-2026-07/done/` is authoritative for settlement implementation. Current project state: `docs/plan/CURRENT.md` and `docs/plan/ready|done/`.
...
`docs/history/hackathon-2026-07/planning/11b-b-moka-staging-and-g1.md` is retained only as a
