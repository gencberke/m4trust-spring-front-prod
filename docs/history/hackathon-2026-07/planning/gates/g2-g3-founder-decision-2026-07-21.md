...
- Status: `ACCEPTED`
- Charter: `docs/history/hackathon-2026-07/planning/gates/settlement-release-readiness-charter-2026-07-21.md`
- Execution guide: `docs/history/hackathon-2026-07/planning/settlement-release-roadmap-runbook.md`
...
- Supersession note: G2's standard-merchant-pool/test-credential route was
  ...
  `docs/history/hackathon-2026-07/planning/gates/simulation-only-payment-decision-2026-07-22.md`. This file
...
This record is documentation-only under `docs/history/hackathon-2026-07/planning/gates/` plus accepted-state and
...
- `docs/history/hackathon-2026-07/planning/14b-settlement-and-release.md` stays in `planning/` and
