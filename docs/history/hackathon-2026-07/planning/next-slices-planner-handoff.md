...
- Slice 14A planı
  `docs/history/hackathon-2026-07/done/14a-dispute-and-casework-foundation.md` altındadır.
- Kabul kanıtı `docs/history/hackathon-2026-07/done/review/14a-15p4-implementation-review-handoff.md` içindedir.
...
Kanıt: `docs/history/hackathon-2026-07/done/review/14a-15p4-implementation-review-handoff.md` (Deal
...
`docs/history/hackathon-2026-07/planning/14b-settlement-and-release.md` henüz implementation-authorizing
