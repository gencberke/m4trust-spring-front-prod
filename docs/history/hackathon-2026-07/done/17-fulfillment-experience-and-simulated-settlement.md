...
- Relationship to `docs/history/hackathon-2026-07/planning/14b-settlement-and-release.md`: that
...
recorded in a review handoff under `docs/history/hackathon-2026-07/done/review/` when the slice is
accepted.
