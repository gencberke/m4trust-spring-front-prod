...
- The next relevant fulfillment-history browser run must visibly retire the
  ...
  closure documents.
- `docs/history/hackathon-2026-07/planning/14b-settlement-and-release.md` is a separate gated future
...
- Confirm V15–V21, AI/messaging contracts, payment/provider, deployment,
  ...
  unchanged.
- Replace `docs/history/hackathon-2026-07/review/req-review.md` with branch/base/HEAD, P1–P8 outcomes,
...
- Reviewer reads `docs/history/hackathon-2026-07/review/req-review.md` only as an index/claim, then
