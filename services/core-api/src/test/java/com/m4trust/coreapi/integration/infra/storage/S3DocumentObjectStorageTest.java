...
import com.m4trust.coreapi.document.infra.DocumentObjectStorage.VerifiedObject;
...
class S3DocumentObjectStorageTest {
  ...
  void verificationHashesVersionPinnedBytesWhenProviderDoesNotReturnChecksum() {
    HeadObjectResponse head =
        HeadObjectResponse.builder().contentLength(3L).versionId("immutable-version").build();
    S3Client client =
        (S3Client)
  ...
  void verificationUsesProviderChecksumWhenItIsAuthoritative() {
    HeadObjectResponse head =
        HeadObjectResponse.builder()
            ...
            .checksumSHA256("ungWv48Bz+pBQUDeXa4iI7ADYaOWF3qc tBD/YfI AFa0=".replace(" ", ""))
            .build();
    S3Client client =
        (S3Client)
            Proxy.newProxyInstance(
    ...
    S3DocumentObjectStorage storage =
        new S3DocumentObjectStorage(client, null, properties(), Clock.systemUTC());

    assertThat(storage.verify("documents/random").sha256())
        .isEqualTo("ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad");
  }
