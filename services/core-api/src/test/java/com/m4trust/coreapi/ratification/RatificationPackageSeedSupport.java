...
public final class RatificationPackageSeedSupport {
  ...
  public static SeededSnapshot seedSnapshot(
    ...
    RatificationSnapshotAssembler assembler =
        new RatificationSnapshotAssembler(objectMapper, new CanonicalSnapshotHasher());
    ...
    RatificationSourcePorts.Target target =
        new RatificationSourcePorts.Target(
            ...
            ruleSetId,
            packageId);
    RatificationSnapshotAssembler.Result assembled =
        assembler.assemble(
            target,
    ...
    return new SeededSnapshot(
        UUID.randomUUID(), assembled.serializedSnapshot(), assembled.contentHash());
  }
}
