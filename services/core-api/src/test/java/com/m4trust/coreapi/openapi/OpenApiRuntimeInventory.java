 ...
 * Idempotency-Key) are covered by committed OpenAPI plus focused MockMvc HTTP tests.
 */
final class OpenApiRuntimeInventory {
  ...
  private static Set<Parameter> inventoryParameters(
    ...
    for (Object parameterNode : parameterList) {
      ...
      boolean required =
          parameter.containsKey("required") ? Boolean.TRUE.equals(parameter.get("required")) : true;
