...
class DealPartyMigrationIntegrationTest {
  ...
  void v10MigratesExistingV9DealsWithNullableUnassignedParties() {
    ...
    insertV9DealFixture(jdbcTemplate, tenantId, userId, legalEntityId, dealId);
  ...
  private void insertV9DealFixture(
    ...
    jdbcTemplate.update(
        """
                ...
                """,
        userId,
        "deal-party-migration@example.com",
        "test-hash",
