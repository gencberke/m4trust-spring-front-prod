...
class RatificationV2CreateIntegrationTest {
  ...
  void createWithoutDisputeWindowProducesV1Snapshot() throws Exception {
    ...
    MvcResult created =
        createPackage(dealId, buyer, currentDealVersion(dealId), 5_000, "TRY", null)
  ...
  void createWithDisputeWindowProducesV2SnapshotAndDistinctHashes() throws Exception {
    ...
    MvcResult zero =
        createPackage(dealId, buyer, dealVersion, 5_000, "TRY", 0)
            .andExpect(status().isCreated())
    ...
    MvcResult one =
        createPackage(dealId, buyer, currentDealVersion(dealId), 5_000, "TRY", 1)
            .andExpect(status().isCreated())
            .andExpect(jsonPath("$.snapshot.schemaVersion").value(2))
  ...
  private org.springframework.test.web.servlet.ResultActions createPackage(
      ...
      throws Exception {
    String disputeWindow =
        disputeWindowDays == null ? "" : ", \"disputeWindowDays\": " + disputeWindowDays;
