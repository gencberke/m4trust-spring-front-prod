...
class DealParticipantExpandMigrationIntegrationTest {
  ...
  void v7BackfillsOldImageNullWritesBeforeEnforcingParticipantTenant() {
    ...
    insertV5Fixture(jdbcTemplate, tenantId, userId, legalEntityId, existingDealId);
    ...
    insertDeal(jdbcTemplate, legacyImageDealId, tenantId, userId, legalEntityId, "DL-9000000002");
    jdbcTemplate.update(
        """
  ...
  private void insertV5Fixture(
      JdbcTemplate jdbcTemplate, UUID tenantId, UUID userId, UUID legalEntityId, UUID dealId) {
    jdbcTemplate.update(
        """
    ...
    jdbcTemplate.update(
        ...
        "EXISTING-1");
    insertDeal(jdbcTemplate, dealId, tenantId, userId, legalEntityId, "DL-9000000001");
    jdbcTemplate.update(
        """
                INSERT INTO deal_participant (
                    deal_id,
