...
/**
 * ADR-010 §2.6 fail-closed bootstrap, extended by the 2026-07-22 simulation-only decision §2 and
 * ADR-014 §2.1: the sandbox provider must never be selected outside {@code local-sandbox} or the
 * explicit {@code staging}+{@code staging-simulated} pair, and {@code production} is always
 * rejected regardless of any other active profile.
 */
