...
class RatificationPackageTest {
  ...
  void approvalAdvancesVersionWithoutChangingPendingStatus() {
    ...
    assertThrows(RatificationPackage.StaleVersion.class, () -> packageState.approve(1));
    ...
    assertThrows(RatificationPackage.StateConflict.class, () -> packageState.approve(2));
  ...
  private static RatificationPackage pending() {
    return RatificationPackage.create(
        UUID.randomUUID(),
        UUID.randomUUID(),
        UUID.randomUUID(),
        UUID.randomUUID(),
