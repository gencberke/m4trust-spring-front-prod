...
class MokaTransportSafetyTest {
  ...
  void computesCheckKeyInDocumentedOrder() {
    assertEquals(
        "c58ed4af37993f564d88aa9a6560fc59e07fc4f07bbd1153a3a15924a38738c0",
        MokaAuthentication.checkKey("DEALER-001", "fixture-user", "fixture-password"));
    assertEquals(
        "cfc237ded22892af9564f624070cf3264689967bdd409f7eddc7842d6e8d639f",
