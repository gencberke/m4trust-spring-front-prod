...
public class MilestoneRepository {
  ...
  public void insert(
    ...
    jdbcTemplate.update(
        """
                ...
                """,
        milestone.id(),
        milestone.fulfillmentId(),
        milestone.dealId(),
        milestone.title(),
        milestone.description(),
        milestone.status().name(),
        milestone.version(),
        Timestamp.from(milestone.createdAt()),
  ...
  public Optional<Milestone.MilestoneRecord> findByFulfillmentId(UUID fulfillmentId) {
    return jdbcTemplate
        .query(
            "SELECT * FROM fulfillment_milestone WHERE fulfillment_id = ?",
            this::mapMilestone,
            fulfillmentId)
        .stream()
        .findFirst();
  ...
  public Optional<Milestone.MilestoneRecord> findByFulfillmentIdForUpdate(UUID fulfillmentId) {
    return jdbcTemplate
        .query(
            "SELECT * FROM fulfillment_milestone WHERE fulfillment_id = ? FOR UPDATE",
            this::mapMilestone,
            fulfillmentId)
        .stream()
        .findFirst();
  ...
  public List<Milestone.MilestoneRuleReferenceRecord> findRuleReferencesByMilestoneId(
      UUID milestoneId) {
    return jdbcTemplate.query(
        """
                ...
                """,
        this::mapRuleReference,
        milestoneId);
  }

  public boolean update(Milestone.MilestoneRecord milestone, long previousVersion) {
  ...
  private Milestone.MilestoneRuleReferenceRecord mapRuleReference(
