...
public final class DisputeCase {
  ...
  private DisputeCase(DisputeCaseRecord record) {
    ...
    this.fulfillmentStatusAtOpen =
        requireNonBlank(record.fulfillmentStatusAtOpen(), "fulfillmentStatusAtOpen");
  ...
  public static DisputeCase rehydrate(DisputeCaseRecord record) {
    return new DisputeCase(record);
  }

  public static DisputeCase open(
      UUID id,
      UUID dealId,
      UUID tenantId,
      UUID fulfillmentId,
  ...
  public DisputeCaseRecord toRecord() {
    return new DisputeCaseRecord(
        id,
        dealId,
        tenantId,
        fulfillmentId,
  ...
  public void acknowledge(Instant acknowledgedAt, Instant updatedAt) {
  ...
  public void withdraw(Instant withdrawnAt, Instant updatedAt) {
  ...
  public void recordComment(Instant updatedAt) {
    if (!isActive()) {
  ...
  public record DisputeCaseRecord(
      UUID id,
      UUID dealId,
      UUID tenantId,
      UUID fulfillmentId,
