...
public class FulfillmentExceptionHandler {
  ...
  ResponseEntity<ProblemDetail> handleFulfillmentNotFound(HttpServletRequest request) {
    return response(
        ...
        ApiErrorCode.FULFILLMENT_NOT_FOUND,
  ...
  ResponseEntity<ProblemDetail> handleConflict(
      FulfillmentExceptions.Conflict exception, HttpServletRequest request) {
    ...
    return response(
        ...
        ApiErrorCode.valueOf(exception.code().name()),
  ...
  ResponseEntity<ProblemDetail> handleValidation(
      FulfillmentExceptions.Validation exception, HttpServletRequest request) {
