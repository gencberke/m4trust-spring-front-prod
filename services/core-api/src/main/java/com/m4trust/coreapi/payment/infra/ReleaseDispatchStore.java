...
@Repository
public class ReleaseDispatchStore {

  private final JdbcTemplate jdbc;
  private final TransactionTemplate transactions;
  private final Clock clock;

  public ReleaseDispatchStore(JdbcTemplate jdbc, TransactionTemplate transactions, Clock clock) {
    this.jdbc = jdbc;
  ...
  private static DispatchClaim map(ResultSet resultSet) throws SQLException {
    return new DispatchClaim(
        ...
        SettlementRecords.DispatchType.valueOf(resultSet.getString("dispatch_type")),
  ...
  record DispatchClaim(
      ...
      SettlementRecords.DispatchType dispatchType,
      UUID providerKey,
      long amountMinor,
      String currency) {}
}
