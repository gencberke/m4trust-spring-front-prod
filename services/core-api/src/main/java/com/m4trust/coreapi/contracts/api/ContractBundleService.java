...
import com.m4trust.coreapi.contracts.infra.ReleaseIdentityProperties;
...
public final class ContractBundleService {
  ...
  ContractBundleService(
      ContractBundleDigest digestCalculator, ReleaseIdentityProperties releaseIdentity) {
  ...
  public ContractBundleMetadata metadata() {
    return new ContractBundleMetadata(
        "core", releaseIdentity.releaseRevision(), computation.digest(), computation.files());
  }
