...
public interface DocumentObjectStorage {
  ...
  /**
   * Creates the longer-lived immutable download capability carried in an AI command event. Browser
   * links continue to use the regular download TTL.
   */
