...
import com.m4trust.coreapi.identity.infra.security.AuthenticatedSessionManager;
import com.m4trust.coreapi.identity.infra.security.IdentityPrincipal;
import com.m4trust.coreapi.organization.domain.CurrentMembershipQueryPort;
...
public class AuthController {
  ...
  public ResponseEntity<PublicUser> register(
    ...
    PublicUser user =
        identityService.register(request.email(), request.password(), request.displayName());
