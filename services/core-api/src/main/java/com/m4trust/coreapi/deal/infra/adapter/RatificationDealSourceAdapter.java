...
@Service
public class RatificationDealSourceAdapter implements RatificationSourcePorts.DealTarget {
  ...
  public void activateCurrentPackage(UUID dealId, UUID packageId, Instant changedAt) {
    ...
    if (!deals.activateCurrentRatificationPackage(dealId, packageId, version, changedAt)) {
