...
/**
 * Narrow organization-owned query surface for Deal invitation membership validation and legal-name
 * projections.
 */
public interface InvitationLegalEntityQueryPort {

  Optional<InvitationLegalEntityMembership> findCurrentMembership(UUID userId, UUID legalEntityId);
