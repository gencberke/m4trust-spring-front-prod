...
/**
 * Application-layer authorization context resolved for one organization-scoped operation. The
 * active legal entity is request-scoped and is never stored in the authenticated session.
 */
