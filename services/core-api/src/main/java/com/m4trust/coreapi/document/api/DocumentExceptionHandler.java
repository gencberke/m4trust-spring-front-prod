...
class DocumentExceptionHandler {
  ...
  ResponseEntity<ProblemDetail> notFound(HttpServletRequest request) {
    return response(
        ...
        "deal-document-not-found",
        "Document not found",
        "The document was not found.",
        ApiErrorCode.DEAL_DOCUMENT_NOT_FOUND);
  }
  ...
  ResponseEntity<ProblemDetail> forbidden(HttpServletRequest request) {
    return response(
        ...
        ApiErrorCode.DEAL_DOCUMENT_MUTATION_FORBIDDEN);
  }
  ...
  ResponseEntity<ProblemDetail> uploadNotAllowed(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.CONFLICT,
        "deal-document-upload-not-allowed",
        "Document upload is not allowed",
        "This Deal cannot accept a document upload.",
        ApiErrorCode.DEAL_DOCUMENT_UPLOAD_NOT_ALLOWED);
  }
  ...
  ResponseEntity<ProblemDetail> expired(HttpServletRequest request) {
    return response(
        ...
        "Document upload expired",
        "The document upload has expired.",
        ApiErrorCode.DOCUMENT_UPLOAD_EXPIRED);
  }
  ...
  ResponseEntity<ProblemDetail> stateConflict(HttpServletRequest request) {
    return response(
        ...
        ApiErrorCode.DOCUMENT_UPLOAD_STATE_CONFLICT);
  }
  ...
  ResponseEntity<ProblemDetail> verificationFailed(HttpServletRequest request) {
    return response(
        ...
        ApiErrorCode.DOCUMENT_VERIFICATION_FAILED);
  }
  ...
  ResponseEntity<ProblemDetail> downloadNotAvailable(HttpServletRequest request) {
    return response(
        ...
        ApiErrorCode.DOCUMENT_DOWNLOAD_NOT_AVAILABLE);
  }

  @ExceptionHandler(DocumentExceptions.Validation.class)
  ResponseEntity<ProblemDetail> validation(
      DocumentExceptions.Validation exception, HttpServletRequest request) {
