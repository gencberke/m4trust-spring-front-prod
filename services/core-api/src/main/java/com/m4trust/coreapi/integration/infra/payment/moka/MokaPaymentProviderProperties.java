...
record MokaPaymentProviderProperties(
    String baseUri,
    String dealerCode,
    String username,
    String password,
  ...
  MokaTransportSettings transportSettings() {
    return new MokaTransportSettings(
        URI.create(require(baseUri, "baseUri")),
        require(dealerCode, "dealerCode"),
        require(username, "username"),
        require(password, "password"),
        require(connectTimeout, "connectTimeout"),
        require(readTimeout, "readTimeout"),
        require(maxRequestBytes, "maxRequestBytes"),
