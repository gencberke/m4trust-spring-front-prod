...
import com.m4trust.coreapi.contracts.infra.ContractProbeTokenFilter;
...
public class SecurityConfiguration {
  ...
  SecurityFilterChain securityFilterChain(
      ...
      ContractProbeTokenFilter contractProbeTokenFilter)
      throws Exception {
    http.authorizeHttpRequests(
            authorize ->
                authorize
                    .requestMatchers(HttpMethod.GET, "/api/v1/security/csrf")
                    .permitAll()
