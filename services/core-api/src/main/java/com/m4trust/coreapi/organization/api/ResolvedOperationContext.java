...
public @interface ResolvedOperationContext {
  ...
  /**
   * Optional path variable that must equal the active legal-entity header. Future scoped resources
   * whose paths do not contain a legal-entity ID can leave this empty and still reuse membership
   * verification.
   */
