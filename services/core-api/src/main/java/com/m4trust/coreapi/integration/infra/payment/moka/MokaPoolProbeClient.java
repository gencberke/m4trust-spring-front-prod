...
/**
 * Integration-only capability for future empirical pool probes. Its facts are deliberately
 * non-authoritative: no business service, release flow, or settlement/finality projection may treat
 * them as money-movement truth.
 */
