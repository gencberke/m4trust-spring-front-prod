 ...
 *
 * <p>This application intentionally does not component-scan the Core API. It creates only the
 * auto-configured datasource and Flyway infrastructure, then closes the context so the process
 * exits after migration. Startup exceptions remain uncaught and therefore produce a non-zero
 * process exit code.
 */
