package com.m4trust.coreapi.idempotency.api;
  ...
  ResponseEntity<ProblemDetail> handleKeyReused(HttpServletRequest request) {
    ProblemDetail problem =
        ProblemDetail.forStatusAndDetail(
            HttpStatus.CONFLICT, "The idempotency key was already used for a different request.");
    problem.setType(URI.create("https://problems.m4trust.internal/idempotency-key-reused"));
