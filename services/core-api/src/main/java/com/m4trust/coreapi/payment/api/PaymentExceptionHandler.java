...
/**
 * Maps payment service exceptions to the exact Problem Details codes frozen in the OpenAPI
 * contract.
 */
...
class PaymentExceptionHandler {
  ...
  ResponseEntity<ProblemDetail> fundingPlanNotFound(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.NOT_FOUND,
        "funding-plan-not-found",
        "Funding plan not found",
        "The funding plan was not found.",
        ApiErrorCode.FUNDING_PLAN_NOT_FOUND);
  }
  ...
  ResponseEntity<ProblemDetail> fundingUnitNotFound(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.NOT_FOUND,
        "funding-unit-not-found",
        "Funding unit not found",
        "The funding unit was not found.",
        ApiErrorCode.FUNDING_UNIT_NOT_FOUND);
  }
  ...
  ResponseEntity<ProblemDetail> paymentOperationNotFound(HttpServletRequest request) {
    return response(
        ...
        "Payment operation not found",
        "The payment operation was not found.",
        ApiErrorCode.PAYMENT_OPERATION_NOT_FOUND);
  }
  ...
  ResponseEntity<ProblemDetail> dealStaleVersion(HttpServletRequest request) {
    return response(
        ...
        "The Deal was modified by another operation.",
  ...
  ResponseEntity<ProblemDetail> fundingPlanAlreadyExists(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.CONFLICT,
        "funding-plan-already-exists",
        "Funding plan already exists",
        "A funding plan already exists for this Deal.",
        ApiErrorCode.FUNDING_PLAN_ALREADY_EXISTS);
  }
  ...
  ResponseEntity<ProblemDetail> fundingUnitStaleVersion(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.CONFLICT,
        "funding-unit-stale-version",
        "Resource has changed",
        "The funding unit was modified by another operation.",
        ApiErrorCode.FUNDING_UNIT_STALE_VERSION);
  }
  ...
  ResponseEntity<ProblemDetail> fundingUnitAlreadyFunded(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.CONFLICT,
        "funding-unit-already-funded",
        "Funding unit already funded",
        "The funding unit is already FUNDED.",
        ApiErrorCode.FUNDING_UNIT_ALREADY_FUNDED);
  }
  ...
  ResponseEntity<ProblemDetail> paymentOperationStaleVersion(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.CONFLICT,
        "payment-operation-stale-version",
        "Resource has changed",
