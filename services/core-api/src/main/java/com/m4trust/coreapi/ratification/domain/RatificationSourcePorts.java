...
/**
 * Consumer-owned contracts; source modules implement these without ratification reading their
 * repositories.
 */
public final class RatificationSourcePorts {
  ...
  public interface AvailableDocument {
    Optional<Document> find(UUID documentId);
  }

  public interface AcceptedRuleSet {
    Optional<RuleSet> find(UUID ruleSetId);
  }
  ...
  public record RuleSet(UUID ruleSetVersionId, UUID dealId, long version, List<Rule> rules) {
    public RuleSet {
