...
class DealDocumentMutationService implements DealDocumentMutationPort {
  ...
  DealDocumentMutationService(DealRepository repository, DealOperationPolicy operationPolicy) {
  ...
  @Override
  @Transactional(propagation = Propagation.MANDATORY)
  public void repointCurrentDocument(UUID dealId, UUID documentId, Instant changedAt) {
