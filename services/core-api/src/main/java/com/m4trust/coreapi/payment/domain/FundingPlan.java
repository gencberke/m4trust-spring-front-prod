...
public final class FundingPlan {
  ...
  public static FundingPlan create(
      UUID id,
      UUID dealId,
      UUID ratificationPackageId,
      UUID tenantId,
    ...
    return new FundingPlan(
        id, dealId, ratificationPackageId, tenantId, amountMinor, currency, now, now, 0);
  }

  public static FundingPlan rehydrate(FundingRecords.PlanRecord record) {
    return new FundingPlan(
        record.id(),
        record.dealId(),
  ...
  public FundingRecords.PlanRecord toRecord() {
    return new FundingRecords.PlanRecord(
        id,
        dealId,
  ...
  public UUID ratificationPackageId() {
    return ratificationPackageId;
  }
