...
public class ApiExceptionHandler {
  ...
  public ResponseEntity<ProblemDetail> handleValidation(
    ...
    List<FieldValidationError> errors =
        ex.getBindingResult().getFieldErrors().stream().map(this::toFieldValidationError).toList();
  ...
  public ResponseEntity<ProblemDetail> handleUnexpected(
    ...
    LOGGER.error("Unexpected request failure [correlationId={}, path={}]", correlationId, path, ex);
  ...
  private FieldValidationError toFieldValidationError(FieldError fieldError) {
    FieldErrorCode code =
        switch (fieldError.getCode() == null ? "" : fieldError.getCode()) {
