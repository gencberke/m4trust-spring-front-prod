...
class AnalysisExceptionHandler {
  ...
  ResponseEntity<ProblemDetail> conflict(
      AnalysisExceptions.Conflict exception, HttpServletRequest request) {
  ...
  ResponseEntity<ProblemDetail> ruleSetVersionNotFound(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.NOT_FOUND,
        "rule-set-version-not-found",
        "Rule-set version not found",
        "The RuleSetVersion was not found.",
  ...
  ResponseEntity<ProblemDetail> validation(
      AnalysisExceptions.Validation exception, HttpServletRequest request) {
    ProblemDetail problem =
        response(
                ...
                "Review validation failed",
                "A reviewed rule value is invalid.",
    ...
    problem.setProperty(
        ...
        List.of(
            new FieldValidationError(
                exception.field(), FieldErrorCode.INVALID, "The value is invalid.")));
