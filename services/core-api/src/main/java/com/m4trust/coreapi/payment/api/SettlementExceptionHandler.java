...
class SettlementExceptionHandler {
  ...
  ResponseEntity<ProblemDetail> settlementNotFound(HttpServletRequest request) {
    return response(
        ...
        "Settlement not found",
        "The settlement projection was not found.",
  ...
  ResponseEntity<ProblemDetail> releaseOperationNotFound(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.NOT_FOUND,
        "release-operation-not-found",
        "Release operation not found",
        "The release operation was not found.",
        ApiErrorCode.RELEASE_OPERATION_NOT_FOUND);
  }
  ...
  ResponseEntity<ProblemDetail> settlementStaleVersion(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.CONFLICT,
        "settlement-stale-version",
        "Resource has changed",
        "The settlement was modified by another operation.",
        ApiErrorCode.SETTLEMENT_STALE_VERSION);
  }
  ...
  ResponseEntity<ProblemDetail> fulfillmentStaleVersion(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.CONFLICT,
        "fulfillment-stale-version",
        "Resource has changed",
        "The fulfillment was modified by another operation.",
        ApiErrorCode.FULFILLMENT_STALE_VERSION);
  }
  ...
  ResponseEntity<ProblemDetail> releaseOperationStaleVersion(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.CONFLICT,
        "release-operation-stale-version",
        "Resource has changed",
  ...
  ResponseEntity<ProblemDetail> contractualWindowMissing(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.CONFLICT,
        "settlement-contractual-window-missing",
  ...
  ResponseEntity<ProblemDetail> disputeWindowNotElapsed(HttpServletRequest request) {
    return response(
        request,
        HttpStatus.CONFLICT,
        "settlement-dispute-window-not-elapsed",
