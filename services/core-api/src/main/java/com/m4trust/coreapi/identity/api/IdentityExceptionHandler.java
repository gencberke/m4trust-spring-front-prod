...
import com.m4trust.coreapi.identity.domain.DuplicateEmailException;
import com.m4trust.coreapi.identity.domain.InvalidCredentialsException;
import com.m4trust.coreapi.identity.domain.WeakPasswordException;
...
public class IdentityExceptionHandler {
  ...
  public ResponseEntity<ProblemDetail> handleWeakPassword(
      WeakPasswordException ex, WebRequest request, HttpServletRequest httpRequest) {
    ...
    problem.setProperty(
        ...
        List.of(
            new FieldValidationError(
                "password",
                FieldErrorCode.PASSWORD_TOO_COMMON,
  ...
  public ResponseEntity<ProblemDetail> handleDuplicateEmail(
      DuplicateEmailException ex, WebRequest request, HttpServletRequest httpRequest) {
    return response(
        HttpStatus.CONFLICT,
        baseProblem(
            HttpStatus.CONFLICT,
  ...
  public ResponseEntity<ProblemDetail> handleInvalidCredentials(
      InvalidCredentialsException ex, WebRequest request, HttpServletRequest httpRequest) {
    return response(
