...
class AnalysisController {
  ...
  DealDocumentAnalysis get(
      @ResolvedOperationContext(RequestedOperation.DEAL_DOCUMENT_ANALYSIS_READ)
  ...
  ResponseEntity<DealDocumentAnalysis> request(
      @ResolvedOperationContext(RequestedOperation.DEAL_DOCUMENT_ANALYSIS_REQUEST)
          OperationContext context,
      @PathVariable String dealId,
    ...
    DealDocumentAnalysis accepted =
        service.request(context, parsedDealId, uuid(idempotencyKey), uuid(correlationId));
