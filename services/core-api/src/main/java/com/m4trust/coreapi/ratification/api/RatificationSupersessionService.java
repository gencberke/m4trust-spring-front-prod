...
@Service
public class RatificationSupersessionService implements RatificationSupersessionPort {
  ...
  public RatificationSupersessionService(RatificationRepository packages, AuditAppendPort audit) {
