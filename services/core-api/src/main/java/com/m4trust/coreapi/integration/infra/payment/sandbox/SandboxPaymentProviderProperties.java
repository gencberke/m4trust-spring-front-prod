...
/**
 * Startup-config-only deterministic scenario sequence: there is no runtime test-control endpoint,
 * header, or body field, and business amount/currency never select a scenario.
 */
