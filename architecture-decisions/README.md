...
Slice 12'nin immutable VIDEO/MP4 veya PHOTO JPEG/PNG evidence kaydına karşı
explicit buyer ADMIN analysis action'ını, fulfillment-owned job/result
history'sini, mevcut video messaging contract eşlemesini ve
advisory-only/no-side-effect sınırını tanımlar.
